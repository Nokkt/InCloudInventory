      ...
      <div className="p-4 md:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow border">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <Link href="/products">
                <a className="bg-blue-50 hover:bg-blue-100 transition-colors p-4 rounded-lg border border-blue-200 flex flex-col items-center text-center">
              ...
              <Link href="/stock">
                <a className="bg-green-50 hover:bg-green-100 transition-colors p-4 rounded-lg border border-green-200 flex flex-col items-center text-center">
              ...
              <Link href="/orders">
                <a className="bg-purple-50 hover:bg-purple-100 transition-colors p-4 rounded-lg border border-purple-200 flex flex-col items-center text-center">
              ...
              <Link href="/expiration">
                <a className="bg-red-50 hover:bg-red-100 transition-colors p-4 rounded-lg border border-red-200 flex flex-col items-center text-center">
                  ...
                  <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        ...
                        <div className="mt-3">
                          <Link href="/low-stock">
                            <a className="text-sm font-medium text-orange-800 hover:text-orange-600">
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        ...
                        <div className="mt-3">
                          <Link href="/expiration">
                            <a className="text-sm font-medium text-red-800 hover:text-red-600">
                              View expiring items →
                            </a>
                          </Link>
                        </div>
